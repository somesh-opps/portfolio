        ...
        <div className="lg:hidden flex justify-center">
          <div className="w-full max-w-md p-6 rounded-2xl border border-muted/40 bg-muted/30">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 bg-muted/20 rounded-lg glow-on-hover">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-12">
              ...
              <div className="lg:w-1/2 lg:text-right space-y-4">
                  ...
                  <div className="hidden lg:flex lg:justify-end">
                    <div className="w-fit">
                      {/* Email card */}
                    <div className="p-4 rounded-lg border border-border bg-card/50 backdrop-blur glow-on-hover w-fit">
                        <div className="flex items-start gap-3">
                          <div className="w-10 h-10 rounded-md bg-primary/20 flex items-center justify-center mt-1">
                            <Mail size={18} className="text-primary" />
                          </div>
                          <div className="min-w-0 pl-0">
                            <div className="text-xs text-muted-foreground">EMAIL</div>
                            <a href="mailto:someshkumarsahoo28@gmail.com" className="font-semibold text-sm text-foreground break-words">someshkumarsahoo28@gmail.com</a>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="mt-4 w-56">
                        <div className="p-3 rounded-lg border border-border bg-card/50 backdrop-blur glow-on-hover">
                          <div className="flex items-start gap-3">
                            <div className="w-10 h-10 rounded-md bg-primary/20 flex items-center justify-center mt-0.5">
            ...
            <div className="flex justify-center lg:justify-start gap-6 mt-10 mb-6 -ml-32">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 bg-primary/20 hover:bg-primary/30 rounded-lg flex items-center justify-center glow-on-hover group relative"
                aria-label="LinkedIn"
              >
