...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="bg-muted/50 py-20 relative">
  <div className="container mx-auto px-6 lg:pl-32">
        ...
        <div className="lg:hidden flex justify-center">
          <div className="w-full max-w-md p-6 rounded-2xl border border-muted/40 bg-muted/30">
            ...
            <div className="flex justify-center gap-4 mt-4">
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-blue-100/30 flex items-center justify-center">
                <Linkedin size={18} className="text-foreground" />
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-blue-100/30 flex items-center justify-center">
                <Twitter size={18} className="text-foreground" />
              </a>
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-blue-100/30 flex items-center justify-center">
        ...
        <div className="hidden lg:block">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {/* Social Links */}
            <div className="flex justify-center lg:justify-start gap-6 mt-16 mb-8 -ml-32">
              <a
                href="https://linkedin.com"
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 bg-blue-100 hover:bg-blue-200 rounded-lg flex items-center justify-center transition-all hover:scale-110"
                aria-label="LinkedIn"
              >
