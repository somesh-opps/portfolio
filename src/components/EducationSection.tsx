  ...
  const education = [
    {
      ...
      board: "Computer Science and Technology",
      score: "Ongoing",
      year: "2024 - Present",
      description: "Currently pursuing Bachelor of Technology in Computer Science and Technology"
    },
    {
      level: "12th Board",
          ...
          {education.map((edu, index) => (
            <div key={index} className="relative flex items-start mb-12 last:mb-0">
              ...
              <div className="ml-0 md:ml-16 w-full">
                <Card className="p-6 hover:shadow-lg transition-all duration-300 bg-card/50 backdrop-blur border-muted relative">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">{edu.board}</p>
